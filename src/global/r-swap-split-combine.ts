import { SwapSplitCombine } from "ttpg-darrell";

export function createSwapSplitCombine(): SwapSplitCombine {
  return new SwapSplitCombine([
    {
      src: { nsids: ["token:base/infantry-1", "unit:base/infantry"], count: 3 },
