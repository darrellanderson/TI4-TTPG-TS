...
it("map string", () => {
  ...
  expect(mapString).toBe(
    "{112} 25 -115 -110 -111 -112 -113 22 2 -115 0 -110 0 -111 0 -112 0 -113 0 5 21 -115 1 -115 -110 -110 -110 -111 -111 -111 -112 -112 -112 -113 -113 -113 23"
  );
...
it("static map string", () => {
  ...
  expect(mapString).toBe(
    "{112} -114 -115 2 -111 -112 -113 -114 -1 -115 -1 1 -1 -111 -1 -112 -1 -113 -1 -114 -1 -1 -115 -1 -1 5 -1 -1 -111 -1 -1 -112 -1 -1 -113"
  );
});
