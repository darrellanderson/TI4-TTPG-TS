...
import { z } from "zod";
export declare const UnitModifierCardClass: z.ZodReadonly<z.ZodEnum<["action", "agenda", "agent", "alliance", "commander", "event", "faction-ability", "hero", "legendary", "mech", "promissory", "relic", "technology.blue", "technology.green", "technology.red", "technology.yellow", "technology.unit-upgrade", "unit"]>>;
...
export declare const UnitModifierTrigger: z.ZodReadonly<z.ZodObject<{
    cardClass: z.ZodReadonly<z.ZodEnum<["action", "agenda", "agent", "alliance", "commander", "event", "faction-ability", "hero", "legendary", "mech", "promissory", "relic", "technology.blue", "technology.green", "technology.red", "technology.yellow", "technology.unit-upgrade", "unit"]>>;
    ...
    nsidName: string;
    cardClass: "action" | "promissory" | "mech" | "unit" | "agenda" | "agent" | "alliance" | "commander" | "event" | "faction-ability" | "hero" | "legendary" | "relic" | "technology.blue" | "technology.green" | "technology.red" | "technology.yellow" | "technology.unit-upgrade";
...
export declare const UnitModifierPriority: z.ZodReadonly<z.ZodEnum<["mutate", "mutate-late", "adjust", "adjust-late", "choose"]>>;
