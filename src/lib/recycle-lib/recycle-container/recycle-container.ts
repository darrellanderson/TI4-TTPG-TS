...
import { RecycleCardEvent } from "../handlers/card/event/recycle-card-event";
...
import { RecycleCardTfAbility } from "../handlers/card/tf-ability/recycle-tf-ability";
import { RecycleCardTfAction } from "../handlers/card/tf-action/recycle-tf-action";
import { RecycleCardTfEdict } from "../handlers/card/tf-edict/recycle-tf-edict";
import { RecycleCardTfGenome } from "../handlers/card/tf-genome/recycle-tf-genome";
import { RecycleCardTfUnitUpgrade } from "../handlers/card/tf-unit-upgrade/recycle-tf-unit-upgrade";
import { RecycleCardTfParadigm } from "../handlers/card/tf-paradigm/recycle-tf-paradigm";
...
RecycleContainer.addHandler(new RecycleCardEvent());
...
RecycleContainer.addHandler(new RecycleCardTfAbility());
RecycleContainer.addHandler(new RecycleCardTfAction());
RecycleContainer.addHandler(new RecycleCardTfEdict());
RecycleContainer.addHandler(new RecycleCardTfGenome());
RecycleContainer.addHandler(new RecycleCardTfUnitUpgrade());
RecycleContainer.addHandler(new RecycleCardTfParadigm());
