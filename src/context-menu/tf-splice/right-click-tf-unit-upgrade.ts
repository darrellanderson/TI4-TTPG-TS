...
const ACTION_PREFIX: string = "*Splice unit upgrade ";

export class RightClickTFUnitUpgradeSplice extends AbstractRightClickDeck {
  constructor() {
    const deckNsidPrefix: string = "card.tf-unit-upgrade:";
