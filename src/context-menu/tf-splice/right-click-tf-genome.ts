...
const ACTION_PREFIX: string = "*Splice genome ";

export class RightClickTFGenomeSplice extends AbstractRightClickDeck {
  constructor() {
    const deckNsidPrefix: string = "card.tf-genome:";
