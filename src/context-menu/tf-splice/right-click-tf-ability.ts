...
const ACTION_PREFIX: string = "*Splice ability ";

export class RightClickTFAbilitySplice extends AbstractRightClickDeck {
  constructor() {
    const deckNsidPrefix: string = "card.tf-ability:";
