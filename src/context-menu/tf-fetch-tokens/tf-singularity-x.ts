...
const CARD_NSID: string = "card.tf-ability:twilights-fall/singularity-x";
const ACTION_NAME: string = "*Fetch Singularity Token";
const TOKEN_NSID: string = "token:base/nekro-x";

export class TFSingularityX extends AbstractRightClickCard {
  constructor() {
