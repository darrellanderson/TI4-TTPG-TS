...
/**
 * Empyrean Paradigm Opening the Eye
 *
 ...
 */
export class ParadigmOpeningTheEye extends AbstractRightClickCard {
  constructor() {
    const cardNsidPrefix: string = "card.tf-paradigm:twilights-fall/opening-the-eye";
    const customActionName: string = "*Opening the Eye";
