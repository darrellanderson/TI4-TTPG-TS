...
const templateFilenames = (0, klaw_sync_1.default)("/Users/darrell/Downloads/t/Templates/card", {
    filter: (item) => path.extname(item.path) === ".json",
    nodir: true,
    traverseAll: true,
}).map((item) => item.path);
const templateIdToCardNsids = {};
...
console.log(txt);
//# sourceMappingURL=extract-old-templates.js.map