...
const grid_ui_builder_1 = require("./grid-ui-builder");
...
function go() {
    const grid = new grid_ui_builder_1.GridUIBuilder()
        .addUIs([
        new MyAbstractUI("1"),
        new MyAbstractUI("2"),
        new MyAbstractUI("3"),
...
setTimeout(go, 1000);
//# sourceMappingURL=grid-ui-builder.testp.js.map