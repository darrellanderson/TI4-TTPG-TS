...
const suggested_settings_ui_1 = require("./suggested-settings-ui");
function go() {
    const scale = 1;
    const abstractUi = new suggested_settings_ui_1.SuggestedSettingsUI(scale);
...
setTimeout(go, 100);
//# sourceMappingURL=suggested-settings-ui.testp.js.map