...
const player_action_phase_time_ui_1 = require("./player-action-phase-time-ui");
function go() {
    const scale = 1;
    const abstractUi = new player_action_phase_time_ui_1.PlayerActionPhaseTimeUI(scale);
...
setTimeout(go, 100);
//# sourceMappingURL=player-action-phase-time-ui.testp.js.map