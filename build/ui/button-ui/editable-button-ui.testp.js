...
const editable_button_ui_1 = require("./editable-button-ui");
function go() {
    const scale = 1;
    const abstractUi = new editable_button_ui_1.EditableButtonUI(scale);
...
setTimeout(go, 100);
//# sourceMappingURL=editable-button-ui.testp.js.map