...
const combat_ui_hex_1 = require("./combat-ui-hex");
function go() {
    const system = TI4.systemRegistry.getBySystemTileNumber(19);
    if (!system) {
        throw new Error("system is undefined");
    }
    const planet = system.getPlanets()[0];
    if (!planet) {
        throw new Error("planet is undefined");
    }
    const scale = 1;
    const abstractUi = new combat_ui_hex_1.CombatUIHex(scale);
...
setTimeout(go, 1000);
//# sourceMappingURL=combat-ui-hex.testp.js.map