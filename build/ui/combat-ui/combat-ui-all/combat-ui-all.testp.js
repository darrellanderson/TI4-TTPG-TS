...
const combat_ui_all_1 = require("./combat-ui-all");
function go() {
    const scale = 1;
    const playerSlot = 10;
    const abstractUi = new combat_ui_all_1.CombatUIAll(scale, playerSlot);
...
setTimeout(go, 1000);
//# sourceMappingURL=combat-ui-all.testp.js.map