...
import { z } from "zod";
export declare const UnitModifierCardClass: z.ZodReadonly<z.ZodEnum<["action", "agenda", "agent", "alliance", "breakthrough", "commander", "event", "faction-ability", "hero", "legendary", "mech", "promissory", "relic", "technology.blue", "technology.green", "technology.red", "technology.yellow", "technology.unit-upgrade", "unit"]>>;
